...
A Pen created on CodePen.io. Original URL: [https://codepen.io/takaneichinose/pen/xvpqgo](https://codepen.io/takaneichinose/pen/xvpqgo).

A simple and a little bit colorful design concept of a profile card.

This is my first time to use the Stylus CSS preprocessor. This challenge was the best opportunity for me to try it (I just coded it after I forked, without changing the preprocessor/s).
